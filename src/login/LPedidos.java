 ...
 * @author argue
 */
public class LPedidos extends javax.swing.JFrame {
    ...
    public void cargarPedidos(){
        ...
        try {
            ps=conexion.prepareStatement("select productos, importe, cliente from pedido");
            rs=ps.executeQuery();
            
            jTablePedidos=new JTable(model);
            jScrollPane1.setViewportView(jTablePedidos);
            
            
            model.addColumn("Productos");
            model.addColumn("Importe pedido");
    ...
    private void initComponents() {
        ...
        jLabelInicio.setText("Lista Pedidos");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, 570, 310));
